...
function arrayFrom(arrayLikeObject){
    var arr = [].slice.call(arrayLikeObject);
    return arr;
}
...
*/
/*I'm using reduce here to filter returned numbers, but 1rst I need to get the arguments in one array*/
...
/* 
Write a function called invokeMax which accepts a function and a maximum amount. invokeMax should return a function that when 
called increments a counter. If the counter is greater than the maximum amount, the inner function should return "Maxed Out"
...
/*every time a function is created using the `function` keyword, a new arguments keyword is assigned to that function.
 So whenever you use arguments inside of a function, the arguments keyword will refer to the specific values passed to that function*/
...
function bind(fn, thisArg){
    /*get the outer args if exists push them into array*/
    var outerArgs = [].slice.call(arguments, 2);
    return function(){
        /*get the inner args if exists push them into array*/
...
function flip(fn, thisArg){
    ...
    return function(){
        ...
        var reverserdArgs = allArgs.reverse();
        return fn.apply(thisArg, reverserdArgs);
