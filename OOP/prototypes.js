...
Examples: 
    ...
    person.family.length // 1
*/
Person.prototype.addToFamily = function(personObject){
    if ((personObject instanceof Person) && (this.family.indexOf(personObject) === -1)){
        this.family.push(personObject);
    }
...
//The function should accept a callback and return a new array with the result of the callback for each value in the array. 
